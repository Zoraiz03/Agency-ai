...
const OurWork = () => {
      ...
      const workData = [
    {
...

     {
      ...
      description: 'We help you create marketing strategies that drive results.',
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <Title title='Our latest work' desc='From strategy to execution, we deliver exceptional results that exceed expectations.' />
